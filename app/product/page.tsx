  ...
  return (
    <main className="relative min-h-screen flex flex-col bg-black text-white font-[Poppins] overflow-hidden">
      ...
      >
        <div className="max-w-2xl text-center md:text-left">
          ...
          <div className="mt-8 space-y-6">
            {[ 
              { 
                title: "CLEANX", 
                desc: "An AI-driven waste management system with real-time tracking" 
              },
              { 
                title: "QMedCard", 
                desc: "A medical card storing comprehensive health records for instant access" 
              },
              { 
                title: "QuantumComm", 
                desc: "An AI-powered communication system for the mining industry" 
              }
        ...
        >
          <img src="/productsbg.jpg" alt="Quantum Products" className="w-[500px] rounded-lg shadow-lg border-4 border-blue-500"/>
        </motion.div>
      </motion.section>
      {/* Footer Section */}
